...
<template>
  <v-container>
    ...
    <v-row v-else v-for="char in characterStore.characters" :key="char.name" >
        <v-btn class="profile-bar character-button justify-start pa-2" variant="text" block height="auto" rounded="lg" @click="characterStore.selectCharacter(char)">
